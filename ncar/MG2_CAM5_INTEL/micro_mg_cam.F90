    ...
    MODULE micro_mg_cam
        ...
        SUBROUTINE micro_mg_cam_tend(dtime, kgen_unit, watchvar)
            ...
            ! Allocate input variables that are updated during substeps.
                        ...
                        CALL kgen_read_real_r8_dim2_alloc(packed_t, kgen_unit, "packed_t", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_q, kgen_unit, "packed_q", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qc, kgen_unit, "packed_qc", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nc, kgen_unit, "packed_nc", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qi, kgen_unit, "packed_qi", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_ni, kgen_unit, "packed_ni", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qr, kgen_unit, "packed_qr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nr, kgen_unit, "packed_nr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qs, kgen_unit, "packed_qs", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_ns, kgen_unit, "packed_ns", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_relvar, kgen_unit, "packed_relvar", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_accre_enhan, kgen_unit, "packed_accre_enhan", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_p, kgen_unit, "packed_p", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_pdel, kgen_unit, "packed_pdel", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_cldn, kgen_unit, "packed_cldn", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_liqcldf, kgen_unit, "packed_liqcldf", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_icecldf, kgen_unit, "packed_icecldf", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_naai, kgen_unit, "packed_naai", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_npccn, kgen_unit, "packed_npccn", watchvar)
                        ...
                        CALL kgen_read_real_r8_dim2_alloc(packed_rate1ord_cw2pr_st, kgen_unit, "packed_rate1ord_cw2pr_st", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_tlat, kgen_unit, "packed_tlat", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qvlat, kgen_unit, "packed_qvlat", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qctend, kgen_unit, "packed_qctend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qitend, kgen_unit, "packed_qitend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nctend, kgen_unit, "packed_nctend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nitend, kgen_unit, "packed_nitend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qrtend, kgen_unit, "packed_qrtend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qstend, kgen_unit, "packed_qstend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nrtend, kgen_unit, "packed_nrtend", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nstend, kgen_unit, "packed_nstend", watchvar)
                        CALL kgen_read_real_r8_dim1_alloc(packed_prect, kgen_unit, "packed_prect", watchvar)
                        CALL kgen_read_real_r8_dim1_alloc(packed_preci, kgen_unit, "packed_preci", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nevapr, kgen_unit, "packed_nevapr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_evapsnow, kgen_unit, "packed_evapsnow", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prain, kgen_unit, "packed_prain", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prodsnow, kgen_unit, "packed_prodsnow", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_cmeout, kgen_unit, "packed_cmeout", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qsout, kgen_unit, "packed_qsout", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_rflx, kgen_unit, "packed_rflx", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_sflx, kgen_unit, "packed_sflx", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qrout, kgen_unit, "packed_qrout", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qcsevap, kgen_unit, "packed_qcsevap", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qisevap, kgen_unit, "packed_qisevap", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qvres, kgen_unit, "packed_qvres", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_cmei, kgen_unit, "packed_cmei", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_vtrmc, kgen_unit, "packed_vtrmc", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_vtrmi, kgen_unit, "packed_vtrmi", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qcsedten, kgen_unit, "packed_qcsedten", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qisedten, kgen_unit, "packed_qisedten", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qrsedten, kgen_unit, "packed_qrsedten", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qssedten, kgen_unit, "packed_qssedten", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_umr, kgen_unit, "packed_umr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_ums, kgen_unit, "packed_ums", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_pra, kgen_unit, "packed_pra", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prc, kgen_unit, "packed_prc", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_mnuccc, kgen_unit, "packed_mnuccc", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_mnucct, kgen_unit, "packed_mnucct", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_msacwi, kgen_unit, "packed_msacwi", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_psacws, kgen_unit, "packed_psacws", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_bergs, kgen_unit, "packed_bergs", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_berg, kgen_unit, "packed_berg", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_melt, kgen_unit, "packed_melt", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_homo, kgen_unit, "packed_homo", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qcres, kgen_unit, "packed_qcres", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prci, kgen_unit, "packed_prci", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prai, kgen_unit, "packed_prai", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qires, kgen_unit, "packed_qires", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_mnuccr, kgen_unit, "packed_mnuccr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_pracs, kgen_unit, "packed_pracs", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_meltsdt, kgen_unit, "packed_meltsdt", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_frzrdt, kgen_unit, "packed_frzrdt", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_mnuccd, kgen_unit, "packed_mnuccd", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nrout, kgen_unit, "packed_nrout", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nsout, kgen_unit, "packed_nsout", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_refl, kgen_unit, "packed_refl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_arefl, kgen_unit, "packed_arefl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_areflz, kgen_unit, "packed_areflz", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_frefl, kgen_unit, "packed_frefl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_csrfl, kgen_unit, "packed_csrfl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_acsrfl, kgen_unit, "packed_acsrfl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_fcsrfl, kgen_unit, "packed_fcsrfl", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_rercld, kgen_unit, "packed_rercld", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_ncai, kgen_unit, "packed_ncai", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_ncal, kgen_unit, "packed_ncal", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qrout2, kgen_unit, "packed_qrout2", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qsout2, kgen_unit, "packed_qsout2", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nrout2, kgen_unit, "packed_nrout2", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nsout2, kgen_unit, "packed_nsout2", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_freqs, kgen_unit, "packed_freqs", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_freqr, kgen_unit, "packed_freqr", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_nfice, kgen_unit, "packed_nfice", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_prer_evap, kgen_unit, "packed_prer_evap", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_qcrat, kgen_unit, "packed_qcrat", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_rel, kgen_unit, "packed_rel", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_rei, kgen_unit, "packed_rei", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_lambdac, kgen_unit, "packed_lambdac", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_mu, kgen_unit, "packed_mu", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_des, kgen_unit, "packed_des", watchvar)
                        CALL kgen_read_real_r8_dim2_alloc(packed_dei, kgen_unit, "packed_dei", watchvar)
        ...
        ! write subroutines
            SUBROUTINE kgen_read_real_r8_dim2_alloc(var, kgen_unit, printvar, watchv, doprint)
                INTEGER, INTENT(IN) :: kgen_unit
                CHARACTER(*), INTENT(IN), OPTIONAL :: printvar
                type(watch), INTENT(IN), OPTIONAL :: watchv
...
#ifndef QFPC
                    IF ( PRESENT(printvar)   .and. PRESENT(doprint) .and. doprint ) THEN
                        PRINT *, "*************** "//printvar//" ****************", var
                     END IF
#endif
#ifdef QFPD
                     IF ( printvar == watchv.var ) then
                        CALL checkpoint(var(watchv.indx1, watchv.indx2), watchv.var)
                     END IF
#endif
                END IF
            ...
            SUBROUTINE kgen_read_real_r8_dim1_alloc(var, kgen_unit, printvar, watchv, doprint)
                INTEGER, INTENT(IN) :: kgen_unit
                CHARACTER(*), INTENT(IN), OPTIONAL :: printvar
                type(watch), INTENT(IN), OPTIONAL :: watchv
                real(KIND=r8), INTENT(OUT), ALLOCATABLE, DIMENSION(:) :: var
...
#ifdef QFPD
        SUBROUTINE checkpoint(addr, label)
          character(*), intent(in) :: label
          real(KIND=r8), intent(in), pointer :: addr
          EXTERNAL INT13
          
          WRITE(0,*) "***checkAddr:", LOC(addr)
          WRITE(0,*) "***checkLen: 8"
          WRITE(0,*) "***checkLab:", label
          CALL INT3()
